...
import {leadsPhase} from "../enum";
import {getTaskFollowList, downloadTaskFollow,} from "@redux-actions/report/serviceReport";
...
class TaskFollowUp extends Component<any, any> {
    constructor(props) {
        super(props);
        this.state = {
            breadCrumbRoutes: [
    ...
    getTaskFollowUpList = () => {
        ...
        getTaskFollowList(params).then(res => {
    ...
    handleDownLoadExcel = () => {
        if (couldDownLoad(this.state.dataSource)) {
            downloadTaskFollow(this.createParams());
        }
    };
}
