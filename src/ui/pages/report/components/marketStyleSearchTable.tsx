...
class MarketStyleSearchTable extends Component<any, any> {
    constructor(props) {
        super(props);
    }
    ...
    render() {
        const {
            channelTypeOptions, dataOptions, selectedChannelType, selectItem, selectedData,
            selectAll, selectedDataAll, selectedChannelTypeAll,
            handleSelectBeginTime, handleSelectEndTime, beginDate, endDate
        } = this.props;
        return (
                ...
                <tr>
                    ...
                    <td>
                        <div className="gym-report-content-wrap">
                            <MonthInput value={beginDate} allowClear={false} onChange={handleSelectBeginTime} disabledDate={this.disabledStartDate}/>
                            <span>-</span>
...
export default MarketStyleSearchTable;
