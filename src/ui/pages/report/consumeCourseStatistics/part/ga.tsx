...
import {getGaConsumeCourse, downloadGAConsumeCourse} from "@redux-actions/report/serviceReport";
...
class GaConsume extends Component<any, any> {
    constructor(props) {
        super(props);
        this.state = {
            columns: [
    ...
    getGaConsumeList = () => {
        ...
        if (timeIsCorrect(startDate.valueOf(), endDate.valueOf())) {
            ...
            getGaConsumeCourse(params).then(res => {
    ...
    handleDownLoadExcel = () => {
        if (couldDownLoad(this.state.dataSource)) {
            downloadGAConsumeCourse(this.createParams());
        }
    };
}

export default GaConsume;
