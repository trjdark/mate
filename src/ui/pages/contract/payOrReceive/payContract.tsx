...
class ContractActionPayContract extends React.Component<any, any> {
    // 路由代码块
        ...
        */
        ...
        getContractDetailAmount(postData).then((res) => {
            if(res.hasPayment === record.hasPayment){
                history.push(`${Routes.确认合同付款.link}${CommonUtils.stringify({
                    aparId:record.aparId,
                    leadsId:record.leadsId,
...
export {ContractActionPayContract}
