...
@form()
class FeedBackStatisticsDetailNew extends React.Component<any, any> {
    ...
    render() {
        const { contentInfo, performanceList, babyNickName,pieceContent} = this.state;
        return (
...
export { FeedBackStatisticsDetailNew };
